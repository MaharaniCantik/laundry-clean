                    ...
                    <tbody class="divide-y divide-surface-variant/50">
                        ...
                        <tr class="hover:bg-surface-container-low/50 transition-colors group {{ $kurir->status_kerja == 'on-delivery' ? 'bg-primary-fixed/5' : '' }} {{ $kurir->status_kerja == 'inactive' ? 'opacity-60' : '' }}">
                            ...
                            <td class="py-4 px-4 text-right">
                                {{-- 1. Jika status kerja kurir BUKAN 'inactive' (alias dia aktif), munculkan tombol tugas/edit --}}
                                ...
                                {{-- 2. Tapi kalau statusnya 'inactive' (Nonaktif), tombolnya hilang dan cuma muncul tanda strip --}}
                                @else
                                <span class="text-on-surface-variant/40 font-body-sm px-3" title="Kurir sedang Libur/Nonaktif">-</span>
                                @endif
                            </td>
                            </td>
                        </tr>
