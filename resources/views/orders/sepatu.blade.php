    ...
    <div class="min-h-screen bg-sky-100/50 pb-12">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
            ...
            <div class="flex items-center gap-1 text-sm font-semibold mb-2">
                ...
                <span class="text-orange-500">Laundry Sepatu</span>
            </div>

            {{-- Judul Besar --}}
            <h1 class="text-3xl font-extrabold text-sky-400 tracking-tight mb-6">Laundry Sepatu</h1>

            {{-- Banner Gambar Gede (Full Width di Container Besar) --}}
            <div class="w-full rounded-3xl overflow-hidden shadow-sm mb-8">
                <img src="{{ asset('images/sepatu.png') }}" alt="Banner Laundry Sepatu class=" w-full h-auto object-cover">
            </div>
        </div>

        {{-- PRICELIST LAUNDRY SEPATU --}}
            ...
            <div class="bg-white rounded-[24px] shadow-sm border border-gray-100 overflow-hidden divide-y divide-gray-100">
                ...
                <div class="flex justify-between items-center p-4 px-6">
                    <div class="space-y-0.5">
                        <h3 class="text-sm font-bold text-gray-700 tracking-wide">Fast Clean</h3>
                        <p class="text-xs text-gray-400 font-medium">Cuci cepat bagian luar (Midsole & Outsole) | Estimasi 3 Hari</p>
                    </div>
                ...
                <div class="flex justify-between items-center p-4 px-6">
                    <div class="space-y-0.5">
                        <h3 class="text-sm font-bold text-gray-700 tracking-wide">Deep Clean</h3>
                        <p class="text-xs text-gray-400 font-medium">Pembersihan menyeluruh (Insole, Upper, Lace) + Anti-Fungus | Estimasi 3 Hari</p>
                    </div>
                    <span class="text-sm font-extrabold text-[#F6921E]">Rp 50.000</span>
                </div>

                <div class="flex justify-between items-center p-4 px-6">
                    <div class="space-y-0.5">
                        <h3 class="text-sm font-bold text-gray-700 tracking-wide">Unyellowing</h3>
                        <p class="text-xs text-gray-400 font-medium">Treatment khusus menghilangkan noda kuning pada sol sepatu | Estimasi 3 Hari</p>
                    </div>
                    <span class="text-sm font-extrabold text-[#F6921E]">Rp 65.000</span>
                </div>
        ...
        <div>
            ...
            <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                ...
                <div class="flex justify-between items-center px-6 py-4 {{ !$loop->last ? 'border-b border-slate-100' : '' }}">
                    ...
                    <span @class([ 'font-bold text-lg' , 'text-blue-500'=> $row['free'],
        ...
        <div>
            ...
            <div class="bg-white rounded-2xl shadow-sm px-6 py-6 space-y-6">
                ...
                <div class="pt-4 flex justify-center">
                    <a href="{{ route('order.checkout', ['layanan' => 'sepatu']) }}"
