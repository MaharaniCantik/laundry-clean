    ...
    <div class="min-h-screen bg-sky-100/50 pb-12">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
            ...
            <div class="flex items-center gap-1 text-sm font-semibold mb-2">
                ...
                <span class="text-orange-500">Laundry Boneka</span>
            </div>

            {{-- Judul Besar --}}
            <h1 class="text-3xl font-extrabold text-sky-400 tracking-tight mb-6">Laundry Boneka</h1>

            {{-- Banner Gambar Gede (Full Width di Container Besar) --}}
            <div class="w-full rounded-3xl overflow-hidden shadow-sm mb-8">
                <img src="{{ asset('images/boneka.png') }}" alt="Banner Laundry Boneka" class="w-full h-auto object-cover">
            </div>
        </div>
        ...
        <div class="max-w-3xl mx-auto px-4 space-y-8">
            ...
            <div>
                <h2 class="text-xl font-bold text-sky-400 mb-3">
                    Pricelist Laundry Boneka
                </h2>
               <div class="bg-white rounded-2xl shadow-sm px-5 py-4">
                   <div class="flex justify-between items-center p-4 px-6">
                        <div class="space-y-0.5">
                            <h3 class="text-sm font-bold text-gray-700 tracking-wide">Kecil (S)</h3>
                            <p class="text-xs text-gray-400 font-medium">Ukuran gantungan kunci hingga ±20 cm | Estimasi 2 hari </p>
                        </div>
                        <span class="text-sm font-extrabold text-[#F6921E]">Rp 20.000</span>
                    </div>

                    <div class="flex justify-between items-center p-4 px-6">
                        <div class="space-y-0.5">
                            <h3 class="text-sm font-bold text-gray-700 tracking-wide">Sedang (M)</h3>
                            <p class="text-xs text-gray-400 font-medium">Ukuran ±20 cm hingga 50 cm (seukuran pelukan anak-anak) | Estimasi 4 hari</p>
                        </div>
                    ...
                    <div class="flex justify-between items-center p-4 px-6">
                        <div class="space-y-0.5">
                            <h3 class="text-sm font-bold text-gray-700 tracking-wide">Besar (L)</h3>
                            <p class="text-xs text-gray-400 font-medium">Ukuran ±50 cm hingga 1 meter | Estimasi 4 hari</p>
                        </div>
                        <span class="text-sm font-extrabold text-[#F6921E]">Rp 60.000</span>
                    </div>

                    <div class="flex justify-between items-center p-4 px-6">
                        <div class="space-y-0.5">
                            <h3 class="text-sm font-bold text-gray-700 tracking-wide">Sangat Besar (XL)</h3>
                            <p class="text-xs text-gray-400 font-medium">Ukuran di atas 1 meter (seperti beruang besar) | Estimasi 7 hari</p>
                        </div>
