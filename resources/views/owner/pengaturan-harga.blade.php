            ...
            <div class="max-w-[1440px] mx-auto p-margin-page">
                <div class="flex justify-between items-end mb-8">
                    ...
                    <div class="flex gap-4">
                        <button type="button" class="flex items-center gap-2 px-6 py-2.5 bg-surface-container-lowest border border-outline-variant text-primary font-body-md rounded-lg hover:bg-surface-container transition-colors">
                                ...
                                <table class="w-full text-left border-collapse">
                                    ...
                                    <tbody class="divide-y divide-outline-variant">
                                        ...
                                        <tr class="hover:bg-primary/5 transition-colors group">
                                            <td class="px-6 py-5">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <span class="font-body-md text-body-md font-medium text-on-surface">Cuci Kering</span>
                                                </div>
                                            </td>
                                            <td class="px-6 py-5">
                                            ...
                                            <td class="px-6 py-5 font-data-tabular text-data-tabular">Rp {{ number_format(env('HARGA_CUCI_KERING', 8000), 0, ',', '.') }} / kg</td>
                                            <td class="px-6 py-5 text-right">
                                                <div class="inline-flex items-center gap-2 bg-surface-container-lowest border border-outline-variant rounded-lg px-3 py-1.5 focus-within:ring-2 focus-within:ring-primary transition-all">
                                                    ...
                                                    <input class="w-20 border-none bg-transparent p-0 font-data-tabular text-data-tabular focus:ring-0 text-right" type="number" name="HARGA_CUCI_KERING" value="{{ env('HARGA_CUCI_KERING', 8000) }}"/>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="hover:bg-primary/5 transition-colors group">
                                            <td class="px-6 py-5">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <span class="font-body-md text-body-md font-medium text-on-surface">Setrika Saja</span>
                                                </div>
                                            </td>
                                            <td class="px-6 py-5">
                                                <span class="px-3 py-1 bg-secondary-container text-on-secondary-container rounded-full font-label-bold text-[11px]">KILOAN</span>
                                            </td>
                                            <td class="px-6 py-5 font-data-tabular text-data-tabular">Rp {{ number_format(env('HARGA_SETRIKA_SAJA', 6000), 0, ',', '.') }} / kg</td>
                                            <td class="px-6 py-5 text-right">
                                                <div class="inline-flex items-center gap-2 bg-surface-container-lowest border border-outline-variant rounded-lg px-3 py-1.5 focus-within:ring-2 focus-within:ring-primary transition-all">
                                                    <span class="text-on-surface-variant text-body-sm">Rp</span>
                                                    <input class="w-20 border-none bg-transparent p-0 font-data-tabular text-data-tabular focus:ring-0 text-right" type="number" name="HARGA_SETRIKA_SAJA" value="{{ env('HARGA_SETRIKA_SAJA', 6000) }}"/>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="hover:bg-primary/5 transition-colors group">
                                            ...
                                            <td class="px-6 py-5 font-data-tabular text-data-tabular">Rp {{ number_format(env('HARGA_LAUNDRY_SEPATU', 35000), 0, ',', '.') }} / psg</td>
                                            <td class="px-6 py-5 text-right">
                                                <div class="inline-flex items-center gap-2 bg-surface-container-lowest border border-outline-variant rounded-lg px-3 py-1.5 focus-within:ring-2 focus-within:ring-primary transition-all">
                                                    <span class="text-on-surface-variant text-body-sm">Rp</span>
                                                    <input class="w-20 border-none bg-transparent p-0 font-data-tabular text-data-tabular focus:ring-0 text-right" type="number" name="HARGA_LAUNDRY_SEPATU" value="{{ env('HARGA_LAUNDRY_SEPATU', 35000) }}"/>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="hover:bg-primary/5 transition-colors group">
                                            <td class="px-6 py-5">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <span class="font-body-md text-body-md font-medium text-on-surface">Dry Cleaning Jas</span>
                                                </div>
                                            </td>
                                            <td class="px-6 py-5">
                                                <span class="px-3 py-1 bg-surface-variant text-on-surface-variant rounded-full font-label-bold text-[11px]">SATUAN</span>
                                            </td>
                                            <td class="px-6 py-5 font-data-tabular text-data-tabular">Rp {{ number_format(env('HARGA_DRY_CLEANING_JAS', 50000), 0, ',', '.') }} / pcs</td>
                                            <td class="px-6 py-5 text-right">
                                                <div class="inline-flex items-center gap-2 bg-surface-container-lowest border border-outline-variant rounded-lg px-3 py-1.5 focus-within:ring-2 focus-within:ring-primary transition-all">
                                                    <span class="text-on-surface-variant text-body-sm">Rp</span>
                                                    <input class="w-20 border-none bg-transparent p-0 font-data-tabular text-data-tabular focus:ring-0 text-right" type="number" name="HARGA_DRY_CLEANING_JAS" value="{{ env('HARGA_DRY_CLEANING_JAS', 50000) }}"/>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="hover:bg-primary/5 transition-colors group">
                                            <td class="px-6 py-5">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <span class="font-body-md text-body-md font-medium text-on-surface">Cuci Bedcover Large</span>
                                                </div>
                                            </td>
                                            <td class="px-6 py-5">
                                                <span class="px-3 py-1 bg-surface-variant text-on-surface-variant rounded-full font-label-bold text-[11px]">SATUAN</span>
                                            </td>
                                            <td class="px-6 py-5 font-data-tabular text-data-tabular">Rp {{ number_format(env('HARGA_BEDCOVER_LARGE', 45000), 0, ',', '.') }} / pcs</td>
                                            <td class="px-6 py-5 text-right">
                                                <div class="inline-flex items-center gap-2 bg-surface-container-lowest border border-outline-variant rounded-lg px-3 py-1.5 focus-within:ring-2 focus-within:ring-primary transition-all">
                                                    <span class="text-on-surface-variant text-body-sm">Rp</span>
                                                    <input class="w-20 border-none bg-transparent p-0 font-data-tabular text-data-tabular focus:ring-0 text-right" type="number" name="HARGA_BEDCOVER_LARGE" value="{{ env('HARGA_BEDCOVER_LARGE', 45000) }}"/>
                                                </div>
                                            </td>
                                        </tr>
