                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-500 mt-0.5">{{ $order->tipe_durasi }} • {{ $order->berat_laundry }} Unit</p>
                                    </div>
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-400 mt-0.5">{{ $task->tipe_durasi }} • ~{{ $task->berat_laundry }} unit</p>
                                    </div>
